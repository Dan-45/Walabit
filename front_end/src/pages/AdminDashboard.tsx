...
export const AdminDashboard = () => {
  return (
    <div className="flex min-h-screen bg-slate-200">
      ...
      <aside className="w-64 bg-slate-50 text-[#64748B] hidden md:flex flex-col p-6">
        <h2 className="text-xl font-bold mb-10 text-black">Admin Panel</h2>
        <nav className="space-y-4 flex-1">
          <a href="#" className="block p-3 rounded-lg hover:bg-amber-300 transition-colors">Dashboard</a>
          <a href="#" className="block p-3 rounded-lg hover:bg-amber-300 transition-colors">Proyectos</a>
          <a href="#" className="block p-3 rounded-lg hover:bg-amber-300 transition-colors">Metricas</a>
          <a href="#" className="block p-3 rounded-lg hover:bg-amber-300 transition-colors">Configuración</a>
        </nav>
        <Link to="/" className="text-sm text-slate-400 hover:text-black text-left">
          Cerrar Sesión
        </Link>
      </aside>
